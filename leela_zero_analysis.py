...
class Leela_Zero_gtp(gtp):
	...
	def __init__(self,command):
		...
		if leela_zero_working_directory:
			...
			self.process=subprocess.Popen(command,cwd=leela_zero_working_directory, stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=False)
		else:
